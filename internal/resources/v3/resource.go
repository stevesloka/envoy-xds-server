...
func MakeEndpoint(clusterName string, eps []resources.Endpoint) *endpoint.ClusterLoadAssignment {
...
func MakeRoute(routes []resources.Route) *route.RouteConfiguration {
	var rts []*route.Route
